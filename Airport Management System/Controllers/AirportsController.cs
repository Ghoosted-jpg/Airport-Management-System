...
namespace Airport_Management_System.Controllers
{
    ...
    public class AirportsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Airport_Name,Size,Area,City,Country")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Airport_Name,Size,Area,City,Country")] Airport airport)
        {
            if (ModelState.IsValid)
            {
