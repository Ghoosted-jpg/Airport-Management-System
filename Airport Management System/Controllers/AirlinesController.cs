...
namespace Airport_Management_System.Controllers
{
    ...
    public class AirlinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Airline_Name,Country,Since")] Airline airline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Airline_Name,Country,Since")] Airline airline)
        {
            if (ModelState.IsValid)
            {
